...
namespace Precor956i.ViewModels
{
    ...
    public partial class MainViewModel : BindableObject, IMainViewModel
    {
        private readonly ITreadmillDomainService _service;
        ...
        public MainViewModel(ILoggingService logger, IConnectionService connections, ITreadmillDomainService service)
        {
            _logger = logger;
