...
public class WorkoutsViewModel : BindableObject, IWorkoutsViewModel
{
  ...
  private void CreateWorkouts()
  {
    ...
    var mainSet = Enumerable.Range(0, 10).SelectMany(i => new[] {
            WorkoutSegment.MetersAtPace(200, "00:5:48.000"),
            WorkoutSegment.MetersAtPace(200, recovery)
          }).ToArray();

    Workouts.Add
    (
      new Workout("2up 10x[200m 200jg] 2dn")
      {
                WorkoutSegment.MilesAtPace(2.0, "00:08:57.000"),

                // strides
                WorkoutSegment.MetersAtPace(100, "00:5:57.000"),
                WorkoutSegment.MetersAtPace(100, recovery),
                WorkoutSegment.MetersAtPace(100, "00:5:54.000"),
                WorkoutSegment.MetersAtPace(100, recovery),
                WorkoutSegment.MetersAtPace(100, "00:5:51.000"),
                WorkoutSegment.MetersAtPace(100, recovery),
                WorkoutSegment.MetersAtPace(100, "00:5:48.000"),
                WorkoutSegment.MetersAtPace(100, recovery),
      ...
      .Then(mainSet)
      .Then(WorkoutSegment.MilesAtPace(2.0, "00:08:57.000"))
      .AtIncline(1)
    );
